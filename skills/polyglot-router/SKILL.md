...
Read `references/operational-workflow.md` before running a complete learning loop. Read `references/system-architecture.md` before changing the skill graph. Read `references/data-contract.md` before writing or interpreting persisted data. Read `references/session-protocol.md` and `references/exercise-protocols.md` before running a study session. Read `references/feedback-protocol.md` and `references/rubrics.md` before correcting or scoring learner output.
